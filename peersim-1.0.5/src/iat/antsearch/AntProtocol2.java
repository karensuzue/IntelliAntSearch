...
public class AntProtocol2 extends SearchProtocol {
    ...
    public AntProtocol2(String prefix) {
        super(prefix);
    ...
    public void process(SMessage msg) {
        ...
        for (int i = 0; i < this.degree(); i++) {
            ...
            PheromoneProtocol pherProtocol = (PheromoneProtocol) whoAmI.getProtocol(linkablePid);
            ...
            if (!neighbor.equals(msg.originator)) {
                ...
                SMessage forwardedMsg = msg.copy();

                // Update TTL of replicated message
                if (pheromone < low_bound) { forwardedMsg.ttl--; }
                else if (pheromone > high_bound) { forwardedMsg.ttl++; }

                // If there is remaining TTL
                if (forwardedMsg.ttl > 0) {
                    this.forward(neighbor, forwardedMsg);
                }
            }
        }
    ...
    @Override
    public Object clone() {
        AntProtocol2 ap = (AntProtocol2) super.clone();
