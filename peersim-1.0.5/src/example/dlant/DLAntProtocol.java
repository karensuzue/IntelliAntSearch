...
public class DLAntProtocol implements EDProtocol {
    ...
    public void startAntSearch(Node startNode, String objectToSearch) {
        AntMessage msg = new AntMessage(startNode.getIndex(), objectToSearch, alpha, calculateInitialTTL());
        EDSimulator.add(0, msg, startNode, transportPid);
    }
    ...
    private void forwardAnt(AntMessage msg, Node currentNode) {
        Linkable linkable = (Linkable) currentNode.getProtocol(Configuration.getPid("protocol.linkable"));
